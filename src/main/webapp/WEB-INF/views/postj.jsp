...
<div class="testbox">
<form id="postJobForm" action="submitpostjob" method="post">
<div class="banner">
<h1>Post job <i class="fa-solid fa-briefcase"></i>, What you need done?</h1>
</div>
<div class="colums">
<div class="item">
<label for="name">Job description<span>*</span></label>
<textarea id="jobDescription" name="description" rows="4" cols="50"></textarea>
</div>
<div class="item">
<label for="title">Job Title<span>*</span></label>
<input type="text" id="title" name="tittle" placeholder="Software Engineer" required />
</div>
<br><br>
<div class="item">
...
<div>
<input type="radio" value="Full Time Role" id="radio_1" name="role" required />
<label for="radio_1" class="radio"><span>Full Time Role</span></label>
</div>
<div>
<input type="radio" value="Freelancing" id="radio_2" name="role" required />
