...
<html lang="en">
  ...
  <body>
    ...
    <header>Start Your Carrier! Registration Here</header>
        <c:if test="${not empty errMsg}">
            <div style="color:red;">${errMsg}</div>
        </c:if>


    <form id="freelancerForm" action="submitFreelancerRegistration" class="form" method="post" enctype="multipart/form-data">
    <div class="column">
        <div class="input-box">
    ...
    <div class="column">
        ...
        <div class="input-box">
            ...
            <input type="text" placeholder="eg. B.Tech" required name="education" />
        </div>
    </div>
    <div class="column">
        <div class="form-group file-area input-box">
            <label for="profilef"><span>Upload Your Profile Photo</span></label>
            <input type="file" name="profilef" id="profilef" accept="image/*" required />
        </div>
        <div class="input-box">
            <label>Basic Charge for your Work (in $x hourly)</label>
            <input type="text" placeholder="eg. 20, 35.5 etc." required name="charge" pattern="^\d+(\.\d{1,2})?$" title="Please enter a valid amount." />
        </div>
    </div>
    <br>
    ...
    <div class="column">
        ...
        <div class="input-box">
            ...
            <input type="password" placeholder="Enter Confirm Password" required name="confirmPassword" />
        </div>
    </div>
...
document.getElementById('freelancerForm').addEventListener('submit', function(event) {
    ...
    var phone = form.elements['number'].value.trim();
    var linkedin = form.elements['linkedin'].value.trim();
    var education = form.elements['education'].value.trim();
    var charge = form.elements['charge'].value.trim();
    var password = form.elements['password'].value.trim();
    var cpassword = form.elements['confirmPassword'].value.trim();
