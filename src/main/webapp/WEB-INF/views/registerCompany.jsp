...
<form id="registrationForm" action="submitCompanyRegistration" class="form" method="post" enctype="multipart/form-data">
    ...
    <div class="input-box">
        ...
        <input type="file" name="profilec" required accept="image/*" title="Please upload a valid image file." />
    </div>
