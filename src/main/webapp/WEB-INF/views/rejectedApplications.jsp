...
<html>
   ...
   <body>
      ...
      <table>
         ...
         <tbody>
            <c:forEach items="${rejectedJobs}" var="e">
               <tr>
                  ...
                  <td>
                     <span style="color:white; background-color:red; padding:0.3rem 0.5rem; border-radius:6px;box-shadow: 0 2px 8px rgba(9,132,227,0.08);">${e.status}</span>
                  </td>
               </tr>
            </c:forEach>
         </tbody>
      ...
      <table>
         ...
         <tbody>
            <c:forEach items="${rejectedProjects}" var="ef">
               <tr>
                  ...
                  <td>
                     <span style="color:white; background-color:red; padding:0.3rem 0.5rem; border-radius:6px;box-shadow: 0 2px 8px rgba(9,132,227,0.08);">${ef.status}</span>
                  </td>
               </tr>
            </c:forEach>
         </tbody>
