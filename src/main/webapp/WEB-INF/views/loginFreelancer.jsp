    ...
    <section class="container">
     <nav class="navbar navbar-expand-lg custom_nav-container">
          <a class="/" href="/SpringMVCPersonal_Project">
            ...
            <span>
              Talent Portal Freelancer Login
            </span>
          </a>
    
      <header>Welcome Back to Talent Portal Login Here</header>
      ...
      <form id="loginForm" action="submitFreelancerLogin" class="form" method="post">
    <div class="input-box">
